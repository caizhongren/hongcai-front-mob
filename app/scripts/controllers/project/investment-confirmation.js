...
angular.module('p2pSiteMobApp')
  .controller('InvestmentConfirmationCtrl', function($scope, $state, $rootScope, $stateParams, fundsProjects, Restangular, restmod, DEFAULT_DOMAIN, config) {
        ...
        if (response.$status === 'ok') {
          ...
          if ($scope.simpleFundsProject.status === 1) {
            if ($rootScope.account) {
              ...
              // console.log($scope.userCanFundsInvestNum);
