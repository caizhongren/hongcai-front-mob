...
刘丽文教授曾于1989年4月至1991年7月在日本东京日中经济法律中心做研究员，1993年1月至7月在加拿大西安大略大学商学院做访问学者，1999 年10月至2000年1月在日本名古屋工业大学系统工程系做研究员，2001年3月至7月在美国华盛顿大学奥林商学院做访问学者，2004年9月至10月在日本中央大学科学与工程研究生院工业及系统工程系做客座教授。目前兼任清华大学现代管理研究中心研究员。'}
    ...
    $scope.partners = [
      ...
      {name: '商务伙伴', eName: 'Bussiness Partners', fa: 'fa-bullhorn', title: '优质金融机构，易宝支付，天畅律师', introduction: '宏财网只与最优质的金融机构合作，资金存管由北京网贷存管通进行存管，并与天畅律师事务所达成战略合作协议。全面确保客户资金安全。'}
    ];
    //安全保障
    $scope.NewSafes = [
    ...
    {name: '资金安全', content: '宏财网联合北京网贷存管通打造了一套完善的风险金控及资金存管系统，一人一户且每笔资金的流动都可追查记录。同时宏财网坚决不设虚假标，每一笔投资都有对应的真实债权，不设资金池，保障投资人的权益。', fa: 'fa-jpy'}
    ];
  });
