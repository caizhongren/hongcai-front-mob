...
angular.module('p2pSiteMobApp')
  .controller('AboutCtrl',['$scope',function ($scope) {
    ...
    $scope.consultants = [
      ...
      {name: '蔡曙涛', img: 'images/head/head-3.png', title: '（经济法学顾问）', introduction: '北京大学教授、北京大学国家高新区发展战略研究院副院长、中国法学会北京经济法学研究会常任理事。曾经于1996年，获北京大学 GE China （中国通用）教学优秀奖 。1997年，获北京大学年度教学优秀奖。'},
      {name: '刘丽文', img: 'images/head/head-4.png', title: '（高级流程优化顾问）', introduction: '清华大学经济管理学院教授、博士生导师。主要研究领域为企业生产与运作管理、供应链管理、JIT和精益生产、物流管理、服务管理、工业工程。 \
