...
/**
 * @ngdoc function
 * @name p2pSiteMobApp.controller:DemoCtrl
 * @description
 * # DemoCtrl
 ...
 */
 define(['./module'], function (controllers) {
    'use strict';
    // controllers.controller('DemoCtrl', function ($scope, $famous) {
    controllers.controller('DemoCtrl', function ($scope) {
